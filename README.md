...
Then open **http://localhost:8501** in your browser. Paste http://localhost:8501 in your browser and not the 0.0.0.0:8501 URL you get OR on Docker Desktop run the port 8501 from the container directly. 
